...
void preOrdem_ArvBin ( ArvBin *raiz ) {
 ...
 int conta_Valor ( ArvBin *raiz, int valor ) {
    ...
    // Caso a árvore não existir ou estiver vazia, encerra o programa
    ...
    contador += conta_Valor ( & ( ( *raiz ) -> esq ), valor );
    contador += conta_Valor ( & ( ( *raiz ) -> dir ), valor );

    return printf ( "\n\nO numero %d aparece %d vezes na arvore especificada\n\n", valor, contador );
