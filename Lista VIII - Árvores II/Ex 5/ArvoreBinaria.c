...
void preOrdem_ArvBin ( ArvBin *raiz ) {
 ...
 int ArvBin_Iguais ( ArvBin *raiz_1, ArvBin *raiz_2 ) {

    // Verifica se ambas as árvores existem e se elas possuem algum elemento
    if ( estaVazia_ArvBin ( raiz_1 ) || estaVazia_ArvBin ( raiz_2 ) ) {
    ...
    // Caso o conteúdo das duas raízes sejam diferentes, encerra o programa
    if ( ( *raiz_1 ) -> info != ( *raiz_2 ) -> info ) {
    ...
    // Verifica recursivamente as subárvores à esquerda e à direita
    return ArvBin_Iguais ( & ( ( *raiz_1 ) -> esq ), & ( ( *raiz_2 ) -> esq ) ) && ArvBin_Iguais ( & ( ( *raiz_1 ) -> dir ), & ( ( *raiz_2 ) -> dir ) );
